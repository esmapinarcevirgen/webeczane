#pragma checksum "C:\Users\esma\Desktop\webeczane2\Views\Fatura\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "8f6e80be74f45a95e5b83061317d988e9fbc1fa3"
// <auto-generated/>
...
[assembly:global::Microsoft.AspNetCore.Mvc.Razor.Compilation.RazorViewAttribute(@"/Views/Fatura/Index.cshtml", typeof(AspNetCore.Views_Fatura_Index))]
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"8f6e80be74f45a95e5b83061317d988e9fbc1fa3", @"/Views/Fatura/Index.cshtml")]
    ...
    public class Views_Fatura_Index : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<dynamic>
    {
    ...
    <div class=""row bg-title"">
        ...
        <div class=""col-lg-9 col-sm-8 col-md-8 col-xs-12"">
            ...
            <ol class=""breadcrumb"">
                ...
                <li class=""active"">Fatura Yönetimi</li>
            </ol>
        </div>
        <!-- /.col-lg-12 -->
    </div>
    ...
    <div class=""modal-dialog"">
        <div class=""modal-content"">
            <div class=""modal-header"">
                ...
                <h4 class=""modal-title"">Fatura</h4>
            </div>
            <div class=""modal-body"">
                <div id=""alertDivModal""></div>
                ");
            EndContext();
            BeginContext(1884, 803, false);
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("form", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "92ff8a11526744d290ffddb1c30f0df0", async() => {
                BeginContext(1900, 780, true);
                WriteLiteral(@"
                    ...
                    <div class=""form-group"">
                        <label for=""pwd"">Depo</label>
                        <select type=""text"" class=""form-control"" id=""Depoid"" name=""DepoId""></select>
                    </div>
                ");
                EndContext();
            }
...
<script>
    ...
    depoSelect = () => $.getJSON('/depo/listesi', (depolar) => depolar.liste.map(depo => $('#Depoid').append('<option value=""' + depo.id + '"">' + depo.adi + '</option>')))

    save = () => {
        $.post('/fatura/kaydet', { item: $('#form').serializeObject() }, (sonuc) => {
            if (sonuc.basarili) {
                listele()
                $('#myModal').modal('hide')
  ...
  ");
    ...
    editItem = (id) => {
        ...
        $('[name=Depoid]').val(item.hastaneid)
        $('#myModal').modal('show')
    }

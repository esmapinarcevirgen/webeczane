#pragma checksum "C:\Users\esma\Desktop\webeczane2\Views\Musteri\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "6c101962f10dc90ecf2e35152d420ecb6fc9f29c"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"6c101962f10dc90ecf2e35152d420ecb6fc9f29c", @"/Views/Musteri/Index.cshtml")]
    ...
    public class Views_Musteri_Index : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<dynamic>
    {
    ...
    <div class=""row bg-title"">
        ...
        <div class=""col-lg-9 col-sm-8 col-md-8 col-xs-12"">
            ...
            <ol class=""breadcrumb"">
                ...
                <li class=""active"">Musteri Yönetimi</li>
            </ol>
        </div>
        <!-- /.col-lg-12 -->
    </div>
    ...
    <div class=""modal-dialog"">
        <div class=""modal-content"">
            <div class=""modal-header"">
                ...
                <h4 class=""modal-title"">Musteri</h4>
            </div>
            <div class=""modal-body"">
                <div id=""alertDivModal""></div>
                ");
            EndContext();
            BeginContext(1859, 1089, false);
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("form", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "5a917bf75d674c2890f33be04163a1de", async() => {
                BeginContext(1875, 1066, true);
                WriteLiteral(@"
                    ...
                    <div class=""form-group"">
                        ...
                        <input type=""text"" name=""TcKimlikNo"" id=""tckimlikno"" placeholder=""TcKimlikNo"" class=""form-control"">
                    </div>
...
");
            ...
            DefineSection("Scripts", async() => {
                BeginContext(3281, 2857, true);
                WriteLiteral(@"
<script>
    $(() => listele())
    save = () => {
        $.post('/musteri/kaydet', { item: $('#form').serializeObject() }, (sonuc) => {
            if (sonuc.basarili) {
                listele()
                $('#myModal').modal('hide')
    ...
    listele = () => {
        ...
        <tr>
            ...
            <td>
                ...
                <button type=""buttton"" class=""btn btn-default"" onclick=""del");
                WriteLiteral(@"eteItem(${item.id})""><i class=""fa fa-trash""></i></button>
                </td>
        </tr>
            `))
            } else {
    ...
    editItem = (id) => {
        ...
        $('[name=Soyadi]').val(item.telefon)
        $('[name=Tckimlikno]').val(item.telefon)
